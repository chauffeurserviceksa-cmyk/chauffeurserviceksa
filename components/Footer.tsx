        ...
        <div style={{ 
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
               ...
               <a href="#" aria-label="Facebook" title="Facebook" style={{ color: 'white', opacity: 0.7 }} onMouseOver={e=>e.currentTarget.style.color='var(--color-gold)'} onMouseOut={e=>{e.currentTarget.style.color='white'; e.currentTarget.style.opacity='0.7'}}>
               ...
               <a href="#" aria-label="Instagram" title="Instagram" style={{ color: 'white', opacity: 0.7 }} onMouseOver={e=>e.currentTarget.style.color='var(--color-gold)'} onMouseOut={e=>{e.currentTarget.style.color='white'; e.currentTarget.style.opacity='0.7'}}>
