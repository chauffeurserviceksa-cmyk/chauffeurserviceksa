...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span style={{ display: 'none' }}>Contact us on WhatsApp</span>
    </motion.a>
  );
}
...
export function SocialSidebar() {
  ...
  const socials = [
    ...
    { name: 'Instagram', Icon: InstagramIcon, color: '#E4405F', link: '#' },
    { name: 'Linkedin', Icon: LinkedinIcon, color: '#0A66C2', link: '#' },
  ];
      ...
      {socials.map((item, idx) => (
        <motion.a 
          ...
          onMouseEnter={(e)=>{
            ...
            e.currentTarget.style.boxShadow = `0 0 20px ${item.color}44`;
          }} 
          onMouseLeave={(e)=>{
